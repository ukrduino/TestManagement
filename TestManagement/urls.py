...
urlpatterns = [
    ...
    url(r'^get_acceptance_builds_info_from_jenkins/$', 'TestCases.views.get_acceptance_builds_info_from_jenkins'),
    url(r'^get_acceptance_job_configs_from_jenkins/$', 'TestCases.views.get_acceptance_job_configs_from_jenkins'),
    url(r'^get_trunk_builds_info_from_jenkins/$', 'TestCases.views.get_trunk_builds_info_from_jenkins'),
    url(r'^get_trunk_job_configs_from_jenkins/$', 'TestCases.views.get_trunk_job_configs_from_jenkins'),
