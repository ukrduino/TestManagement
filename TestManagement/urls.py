...
urlpatterns = [
    ...
    # url(r'^data_collection/super_update/$', TestCases.views.super_update),
    ...
    url(r'^all_test_cases/$', TestCases.views.show_all_disabled_test_cases, name="show_all_test_cases"),
