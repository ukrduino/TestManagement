...
urlpatterns = [
    ...
    url(r'^get_builds_info_from_jenkins/$', 'TestCases.views.get_builds_info_from_jenkins',
        name="get_builds_info_from_jenkins"),
    url(r'^get_job_configs_from_jenkins/$', 'TestCases.views.get_job_configs_from_jenkins',
        name="get_job_configs_from_jenkins"),
